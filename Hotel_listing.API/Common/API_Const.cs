...
public static class API_Const
{
    ...
    internal const string QUERY_DESCR =@"Filter query string in the format <b>field(operator)[value]{logical-operator}field(operator)[value]...</b> 
                       <em>operators => ( =, !=, <, <=, >, >=), 
                       logical-operator => { and , &&, or, ||}</em>
                     ";
    internal const string SORT_DESCR = @"Sort query string in the format <b>field1,field2_desc...</b> 
                       <em>if the <strong>fieldname</strong> is added as query string the records will be sorted on the ascending order, if the <strong>fieldname_desc</strong> is added as query string the records will be sorted on descending order</em>
                     ";
    internal const string ICLUDE_DESCR = @"Include query string for includin relation in the reponse data: <b>Relation1,Realtion2...</b>";
    internal const string SIZE_DESCR = @"Size query string for setting the page size on paginated response data: <b>10 default</b>";
    internal const string PAGE_DESCR = @"Page query string for setting the page number on paginated response data: <b>1 default</b>";
    internal const string MAX_DESCR = @"Max query string for setting the maximum page size on paginated response data: <b>50 default</b>";
    ...
    internal const string PRODUCES_XML = @"application/json";
    ...
    internal const string SWAGGER_RES_DESCR_401 = @"If route is protected";
    internal const string SWAGGER_RES_DESCR_403 = @"";
